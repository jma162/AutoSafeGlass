  ...
  return (
    <div className="sticky top-0 z-50 w-full bg-white shadow">
      <div className="h-20 flex items-center justify-between py-3 px-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-[montserratSemiBold] text-blue-600">
            AutoSafeGlass
          </h1>
        </div>
        ...
        <div className="hidden md:flex items-center gap-10 font-[montserratSemiBold]">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="hidden md:flex items-center gap-2 px-6 py-1.5 bg-blue-500 text-white rounded-3xl hover:bg-blue-600 transition-colors"
            >
